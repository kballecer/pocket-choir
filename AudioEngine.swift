...
//        lead_shifter.shift = lead_shift
    ...
    func change_inputGain(_ gain: Double) {
       // test these not sure which will change
       // input_booster.gain = gain;
       // input_signal.volume = gain;
    }
    
    func change_outputGain(_ gain: Double) {
        // test
        output_mix.volume = gain;
    }
    
    func change_harmonizeGain(_ gain: Double) {
        // test
        harmonizer_mix.volume = gain;
        harmonizer_gain = gain;
